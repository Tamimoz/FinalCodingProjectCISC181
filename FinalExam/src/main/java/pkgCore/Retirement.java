...
public class Retirement {
	...
	public double MonthlySavings() {
		...
		double pmt = Retirement.PMT(dAnnualReturnWorking/12, iYearsToWork*12, 0, this.TotalAmountToSave(), false);
		return pmt;
	}
	...
	public double TotalAmountToSave() {
		...
		double pv = Math.round(Retirement.PV(dAnnualReturnRetired/12,iYearsRetired*12, dRequiredIncome - dMonthlySSI , 0, false)*100)/100;
