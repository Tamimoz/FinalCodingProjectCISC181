...
public class TestFinance {
	...
	public void TestPMT() {
		...
		double PMT = Retirement.PMT(dAnnualReturnWorking/12, iYearsToWork*12, 0, Retirement.PV(dAnnualReturnRetired / 12, iYearsRetired * 12, dRequiredIncome - dMonthlySSI, 0, false) , false);
